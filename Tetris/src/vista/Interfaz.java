...
public class Interfaz {
	...
	// geters/setters
	public void setPresentePieza(int presentePieza) {
		this.presentePieza = presentePieza;
	}
	...
	public void iniciarImagen() {
		...
		case 1: 
			...
			break;
		case 0:
			imagenJuego = new Imagen("./img/Tableros/neptuno.png");
			break;
		case 2:
			imagenJuego = new Imagen("./img/Tableros/sol.png");
			break;
		}
	...
	public int[][] elegirFuturaPieza() {
		

		
		Imagen piezaPequena = null;
		switch (futuraPieza) {
		case 0:
			piezaPequena = PiezaPequena.PIEZACUADRADO.getImagen();

			break;
		case 1:
			piezaPequena = PiezaPequena.PIEZAI.getImagen();

			break;
		case 2:
			piezaPequena = PiezaPequena.PIEZAJ.getImagen();

			break;
		case 3:
			piezaPequena = PiezaPequena.PIEZAL.getImagen();

			break;
		case 4:
			piezaPequena = PiezaPequena.PIEZAS.getImagen();

			break;
		case 5:
			piezaPequena = PiezaPequena.PIEZAT.getImagen();

			break;
		case 6:
			piezaPequena = PiezaPequena.PIEZAZ.getImagen();

			break;

		}
		return piezaPequena.getArray2D();
	}
	
	public void inicializarFuturaPieza() {
	    futuraPieza = generarPiezaAleatoria();
	}
	...
	public int getFuturaPieza() {
		return futuraPieza;
	}

	public void setFuturaPieza(int futuraPieza) {
		this.futuraPieza = futuraPieza;
	}

	public void cambioDePieza() {
	    presentePieza = futuraPieza;
	    futuraPieza = generarPiezaAleatoria();
	}
}
